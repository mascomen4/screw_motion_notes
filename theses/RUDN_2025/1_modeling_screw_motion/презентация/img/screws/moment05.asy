...
// Вектор трансляции
draw(g=shift(v=0.4Z)*(P2--P1), p=0.3bp+black, arrow=Arrow3(size=4), L=Label("$\theta^{o}$"));
// Угол поворота
draw(g=Theta, p=0.3bp+black, arrow=Arrow3(size=3), L=Label("$\theta$"));
